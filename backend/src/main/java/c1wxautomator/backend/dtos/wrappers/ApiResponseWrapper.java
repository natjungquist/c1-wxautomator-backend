...
/**
 * This is a custom class representing a wrapper for API responses.
...
public class ApiResponseWrapper<T> {
    ...
    /**
     * Checks if the response status is 2xx successful.
     *
     * @return true if the response is between 200-299 inclusive.
     */
    ...
    /**
     * Checks if the response includes data.
     *
